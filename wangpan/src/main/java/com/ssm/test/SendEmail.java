...
public class SendEmail {  
    ...
    public static void send(String toEmail , String content) {  
        ...
        try {  
            ...
            builder.append("<p style=\"margin:30px 0 0;color:#c80000;\"><b>如果您需要请点击以下链接!如果非本人操作请忽略</b></p>");
            builder.append("\n链接:"+"<br>");
            builder.append(url);
            builder.append("提取码");
            builder.append(pass);
            builder.append("<br>(如果链接无法点击，请将它拷贝到浏览器的地址栏中)或者点击下面一行");
            builder.append("<br><a href=\""+url);
            builder.append("\">点这里</a>");
            builder.append("<br><span>微信打赏请扫描下面二维码<span><br><img src=\"http://118.89.148.122:8080/wangpan/image/erweima.jpg\">");
