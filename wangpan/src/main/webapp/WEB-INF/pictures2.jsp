		...
		<div class="col-md-12 column" align="center">
			<ul class="pagination">
				  <li> <a>共${pb.totalpage}页</a> </li>
 				  ...
 				  <li><a href="pictures2?pagecode=1">首页</a> </li>
  				<c:if test="${pb.pagecode>1}">
  				 <li><a href="pictures2?pagecode=${pb.pagecode-1}">上一页</a> </li>
  				</c:if>
				<c:choose>
				 ...
				 <c:if test="${end>pb.totalpage}">
				  ...
				  <li> <a href="pictures2?pagecode=${i}">${i}</a></li>
				  </c:forEach>
					<c:if test="${pb.pagecode<pb.totalpage}">
					<li> <a href="pictures2?pagecode=${pb.pagecode+1} ">下一页</a> </li>
					</c:if>
  				<li><a href="pictures2?pagecode=${pb.totalpage}">末页</a></li>
